...
if ($_GET["order_date"] && $_GET["invoice_no"]) {
	...
	$pdf->Cell(190,10,"Inventory System",0,1,"C");  //Cell(width,height,string txt, mixed border, int ln, string align, boolean fill,mixed link) C for centre 0 for no border 1 for newline
